...
public class LottoNumbersGenerator implements RandomNumbersGenerator {
    ...
    // TODO: 30.07.2022 without checking the implementation idk how many numbers will be generated and in what range.
    //  its also not extendable: what if i wanted to generate 3 numbers? or 20? what if i wanted a different range of numbers?
